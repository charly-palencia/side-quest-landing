...
const App = () => (
  <nav className="h-screen text-white justify-between flex flex-col w-14 bg-eerie-50 fixed top-0 left-0 z-50">
    <div className="mt-10 mb-10">
      <a href="#">
        <img src="/SideQuest-Mark-White.svg" alt="" className="w-12 h-12 mx-auto" />
      </a>
      <div className="mt-10">
        <ul>
          <li className="mb-6">
          ...
          <li className="mb-6">
            <a href="#">
              <span>
                <SupportIcon width="20" className="mx-auto hover:text-slate-400"/>
              </span>
            </a>
          </li>
          <li>
            <a href="#">
              <span>
                <SpeakerphoneIcon width="20" className="mx-auto hover:text-slate-400"/>
              </span>
            </a>
          </li>
        </ul>
